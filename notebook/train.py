...
# Data loading params
tf.flags.DEFINE_string("train_dir", "../data/wakari_train_Youto.pickle", "Path of train data")
tf.flags.DEFINE_float("dev_sample_percentage", .1, "Percentage of the training data to use for validation")
tf.flags.DEFINE_integer("max_sentence_length", 100, "Max sentence length in train/test data")
